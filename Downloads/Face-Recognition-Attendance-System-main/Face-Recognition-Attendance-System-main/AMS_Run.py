    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/admin/Downloads/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\admin\Downloads\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check atttendance-------"')
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/admin/Downloads/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main/' + fileName
...
def admin_panel():
    ...
    def log_in():
        ...
        if username == 'praduman':
            if password == 'praduman':
                win.destroy()
                import csv
                import tkinter
                root = tkinter.Tk()
                ...
                cs = 'C:/Users/admin/Downloads/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
                    ...
                    for col in reader:
                        ...
                        for row in col:
                            # i've added some styling
                            label = tkinter.Label(root, width=15, height=1, fg="black", font=('times', 15, ' bold '),
                                                  bg="white", text=row, relief=tkinter.RIDGE)
                            label.grid(row=r, column=c)
                            c += 1
                        r += 1
